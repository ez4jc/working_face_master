...
class Ui_simulate_win(object):
    def setupUi(self, simulate_win):
        ...
        self.gridLayout.addWidget(self.lineEdit_pushSupporter, 3, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_static_wraparound_frame, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_pushSupport, 3, 2, 1, 1)

        self.checkBox_gyro = QCheckBox(simulate_win)
        self.checkBox_gyro.setObjectName(u"checkBox_gyro")

        self.gridLayout.addWidget(self.checkBox_gyro, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_supporter, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pushButton_xoy, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_xoy, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_yoz, 5, 0, 1, 2)
